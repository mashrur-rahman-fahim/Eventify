  ...
  return (
    <div className="card bg-base-100 shadow-lg hover:shadow-xl transition-all duration-300 border border-primary/10 group">
      <div className="card-body p-6">
        ...
        {/* Event Title */}
        <h3 className="card-title text-lg mb-3 text-base-content group-hover:text-primary transition-colors">
        ...
        <div className="space-y-3 mb-4">
          <div className="flex items-center text-sm text-base-content/70">
            ...
            <span className="ml-2">{formatDate(certificate.eventDate)}</span>
          </div>
          ...
          <div className="flex items-center text-sm text-base-content/70">
            ...
            <span className="ml-2">{certificate.clubName}</span>
          </div>
          ...
          <div className="flex items-center text-sm text-base-content/70">
            ...
            <span className="ml-2">{formatDate(certificate.generatedAt)}</span>
          </div>
        </div>
