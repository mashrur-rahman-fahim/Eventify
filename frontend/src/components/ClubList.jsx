...
export const ClubList = ({ clubs, onClubAction }) => {

    const handleLeaveClub = async (clubId) => {
        if (window.confirm('Are you sure you want to leave this club? You will lose admin privileges.')) {
            try {
    ...
    const handleDeleteClub = async (clubId) => {
        if (window.confirm('WARNING: Deleting a club is permanent and will remove all its events. Are you sure?')) {
            try {
